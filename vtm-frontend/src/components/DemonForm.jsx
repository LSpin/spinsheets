...
const TAB_KEYS = ['tabIdentity', 'tabAttributes', 'tabAbilities', 'tabLore', 'tabHealth', 'tabBackstory', 'tabXpLog', 'tabDicePools', 'tabDiceRoller']

const INITIAL = {
  splat: 'DEMON', npc: true,
  ...
  sorceryDesc: '', // Lore powers
  clanCurse: '', // Apocalyptic Form
...
export default function DemonForm() {
  ...
  return (
    <div className={viewMode ? 'form-view-mode' : ''}>
        ...
        <div className="form-section">
          <fieldset>
            ...
            <div className="field-row">
              <div className="field"><label>{t('charName')} *</label><input name="name" value={fields.name} onChange={handleText} placeholder="Mortal host name" /></div>
              <div className="field"><label>Celestial Name</label><input name="altName" value={fields.altName} onChange={handleText} placeholder="True angelic name" /></div>
            </div>
            <div className="field-row">
      ...
      {/* Lore & Apocalyptic Form */}
      <div hidden={tab !== 3}>
        <div className="form-section">
          <fieldset>
            <legend>Lore Powers</legend>
          ...
          <fieldset>
            ...
            <div className="field-row">
              <DotRating label="Faith" name="gnosis" value={fields.gnosis} onChange={handleField} min={0} max={10} />
              <DotRating label="Current Faith" name="currentGnosis" value={fields.currentGnosis} onChange={handleField} min={0} max={10} />
            </div>
            <div className="field-row">
              <DotRating label="Torment" name="rage" value={fields.rage} onChange={handleField} min={0} max={10} />
              <DotRating label="Current Torment" name="currentRage" value={fields.currentRage} onChange={handleField} min={0} max={10} />
            </div>
            <div className="field-row">
