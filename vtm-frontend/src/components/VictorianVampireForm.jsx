...
const INITIAL = {
  // Identity
  npc: false, splat: 'VICTORIAN_VAMPIRE',
  ...
  // Talents (Victorian: Awareness instead of Dodge)
  ...
  // Skills (Victorian: Ride instead of Drive/Security, Larceny instead of Security)
  ...
  // Knowledges (Victorian: Finance instead of Computer, Technology instead of Linguistics)
  academics: 0, enigmas: 0, finance: 0, investigation: 0, law: 0,
  medicine: 0, occult: 0, politics: 0, science: 0, technology: 0,
  academicsSpec: '', enigmasSpec: '', financeSpec: '', investigationSpec: '', lawSpec: '',
...
export default function VictorianVampireForm() {
  ...
  return (
    <div className={viewMode ? 'form-view-mode' : ''}>
      <div className="form-header">
        ...
        <span className="splat-badge splat-badge--victorian-vampire">{t('victorianVampire')}</span>
      ...
      <div hidden={tab !== 2}>
        <div className="form-section">
          ...
          <fieldset>
            ...
            <div className="rating-grid">
              {['academics', 'enigmas', 'finance', 'investigation', 'law', 'medicine', 'occult', 'politics', 'science', 'technology'].map(a =>
                <RatingRow key={a} abilityKey={a} specKey={a + 'Spec'} fields={fields} onField={handleField} onText={handleText} t={t} />
              )}
            </div>
          </fieldset>
        ...
        <div className="form-section">
          ...
          <fieldset>
            ...
            {fields.currentBlood === 0 && (
              <p className="status-error mt-xs text-sm" role="alert" aria-live="assertive" >
          ...
          <fieldset>
              ...
              {isElder && (
                <fieldset>
                  ...
                  <p className="muted-hint mb-sm text-sm" >
                    {t('elderPowersHint')}
                  </p>
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        {filterDisc && (() => {
                          ...
                          return (
                            <div className="mb-md p-sm rounded border" style={{ background: 'var(--color-bg)' }}>
                              <strong className="text-sm" >{baseEntry.name} — Levels 1-5</strong>
              ...
              <fieldset>
                ...
                <div className="combo-grid">
                  ...
                  <div className="field field--full">
                    ...
                    <textarea value={newCombo.description} onChange={e => setNewCombo(p => ({ ...p, description: e.target.value }))} rows={3} placeholder={t('phComboDesc')} className="w-full"  />
                  </div>
      ...
      {/* ── Dice Pools ── */}
      <div hidden={tab !== 13}>
        <DicePoolsTab fields={fields} splat="VICTORIAN_VAMPIRE" characterId={characterId} />
      </div>
