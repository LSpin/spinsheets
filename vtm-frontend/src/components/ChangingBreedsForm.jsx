...
const BACKGROUNDS = [
  { value: 'Allies', description: 'Human friends and contacts who aid the Fera.' },
  ...
  { value: 'Kinfolk', description: 'Human or animal relatives aware of the Fera.' },
  { value: 'Mentor', description: 'An elder who guides and teaches.' },
  { value: 'Rites', description: 'Knowledge and access to rites specific to your breed.' },
