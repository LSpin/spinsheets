    ...
    <div>
        ...
        {rollResult && (
          <div aria-live="polite" className="mt-md">
            <div className="flex gap-sm items-center flex-wrap">
              <span className="font-semibold">{t('savSTDice')}:</span>
      ...
      <fieldset className="form-section mb-lg">
        ...
        <table className="w-full text-base" style={{ borderCollapse: 'collapse' }}>
          <thead>
            <tr>
              <th className="text-left" style={{ padding: 'var(--space-xs)', borderBottom: '1px solid var(--text-muted)' }}>{t('savSTModifier')}</th>
              <th className="text-left" style={{ padding: 'var(--space-xs)', borderBottom: '1px solid var(--text-muted)' }}>{t('savSTCondition')}</th>
            </tr>
          </thead>
          <tbody>
  ...
  return (
    <section aria-labelledby="st-tools-heading">
      <div className="character-list-header">
        <div>
          <button className="btn btn-secondary mr-sm" onClick={() => navigate('/sav')}>
            {t('back')}
          </button>
      ...
      <p className="muted-hint mb-md">{t('savSTToolsDesc')}</p>
