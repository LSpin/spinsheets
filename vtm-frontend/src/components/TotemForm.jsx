...
const TOTEM_SPIRITS = {
  Respect: [
    ...
    { name: 'Eagle', cost: 5, ban: 'Must never show cowardice or flee from battle', benefits: '+2 Leadership, +1 Intimidation for pack' },
    { name: 'City Father/Mother', cost: 5, ban: 'Must protect the city and its inhabitants', benefits: '+2 Streetwise, +2 Politics in the chosen city' },
    { name: 'Dana', cost: 5, ban: 'Must always protect women and children', benefits: '+2 Medicine, +1 Empathy, can sense illness' },
    { name: 'Tambiyah', cost: 4, ban: 'Must always seek peace before combat', benefits: '+2 Etiquette, +1 Empathy for pack' },
  ],
  War: [
    ...
    { name: 'Wolverine', cost: 5, ban: 'Must never surrender or back down once in a fight', benefits: '+2 Brawl, berserker fury in battle' },
    { name: 'Wyvern', cost: 4, ban: 'Must guard a territory and never let it be defiled', benefits: '+2 Alertness, +1 Intimidation for pack' },
    { name: 'Grandfather Thunder', cost: 7, ban: 'Must not show weakness to rivals; must always dominate social interactions', benefits: '+3 Intimidation, +1 Etiquette, spirits of the storm are friendlier' },
    { name: 'Clashing Boom-Boom', cost: 4, ban: 'Must never use the same tactic twice in a row', benefits: '+2 Firearms, +1 to damage with explosives' },
    { name: 'Boar', cost: 5, ban: 'Must never let an insult go unanswered', benefits: '+1 Stamina, +1 Brawl for pack in battle' },
  ],
  Wisdom: [
    ...
    { name: 'Sphinx', cost: 7, ban: 'Must never answer a question directly; reply with a riddle or question', benefits: '+2 Enigmas, +2 Occult, can sense lies' },
    { name: 'Fog', cost: 6, ban: 'Must never reveal pack secrets to outsiders', benefits: '+3 Stealth, +1 Subterfuge, can obscure the pack from detection' },
    { name: 'Phoebe', cost: 6, ban: 'Must create a work of art or beauty each month', benefits: '+2 Expression, +1 Crafts, enhanced creativity in the Umbra' },
    { name: 'Katanka-Sonnak', cost: 5, ban: 'Must patrol and protect a waterway or wetland', benefits: '+2 Survival in aquatic environments, can breathe underwater in the Umbra' },
    { name: 'Turtle', cost: 5, ban: 'Must never act rashly; always deliberate before deciding', benefits: '+2 Survival, +1 Stamina, enhanced endurance' },
    { name: 'Dragonfly', cost: 4, ban: 'Must always be truthful when questioned directly', benefits: '+2 Alertness, +1 Perception, can see into the Penumbra briefly' },
  ],
  Cunning: [
    ...
    { name: 'Fox', cost: 5, ban: 'Must never participate in a fox hunt or allow one to occur', benefits: '+3 Stealth, +2 Subterfuge, can vanish from sight once per scene' },
    { name: 'Jackal', cost: 4, ban: 'Must scavenge and never waste resources', benefits: '+2 Streetwise, +1 Survival, can find sustenance anywhere' },
    { name: 'Trash Heap', cost: 3, ban: 'Must never throw anything away that could be useful', benefits: '+3 Repair, +2 Crafts, can jury-rig broken equipment' },
    { name: 'Whippoorwill', cost: 5, ban: 'Must always heed omens of death and warn the pack', benefits: '+2 Occult, +1 Awareness, can sense impending death' },
  ],
}
