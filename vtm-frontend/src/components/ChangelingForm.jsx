...
const TAB_KEYS = ['tabIdentity', 'tabAttributes', 'tabAbilities', 'tabArts', 'tabHealth', 'tabBackstory', 'tabXpLog', 'tabDicePools', 'tabDiceRoller']

const INITIAL = {
  splat: 'CHANGELING', npc: true,
  ...
  return (
    <div className={viewMode ? 'form-view-mode' : ''}>
        ...
        <div className="form-section">
          <fieldset>
            ...
            <div className="field-row">
              ...
              <div className="field"><label>Fae Name</label><input name="altName" value={fields.altName} onChange={handleText} /></div>
            </div>
            <div className="field-row">
      ...
      <div hidden={tab !== 3}>
        <div className="form-section">
          <fieldset>
            <legend>Arts &amp; Realms</legend>
            <p className="muted-hint muted-hint--xs" style={{ marginBottom: 'var(--space-sm)' }}>
              Arts: Chicanery, Legerdemain, Primal, Pyretics, Soothsay, Sovereign, Wayfare.
          ...
          <fieldset>
            ...
            <div className="field-row">
              <DotRating label="Glamour" name="gnosis" value={fields.gnosis} onChange={handleField} min={0} max={10} />
              <DotRating label="Current Glamour" name="currentGnosis" value={fields.currentGnosis} onChange={handleField} min={0} max={10} />
            </div>
            <div className="field-row">
              <DotRating label="Banality" name="quintessence" value={fields.quintessence} onChange={handleField} min={0} max={10} />
            </div>
            <div className="field-row">
