...
export const SECRET_SOCIETIES = [
  // ── Core Rulebook (10) ──
  { name: 'Brotherhood of the Coast', description: 'Pirate brotherhood dedicated to freedom of the seas. They protect sailors and fight against tyranny on the waves.', source: 'Core Rulebook' },
  { name: 'Die Kreuzritter', description: 'Ancient order fighting supernatural threats in the shadows. They hunt monsters and guard humanity against dark forces.', source: 'Core Rulebook' },
  { name: "Explorer's Society", description: 'Seekers of lost knowledge and ancient artifacts. They fund expeditions and preserve Syrneth ruins.', source: 'Core Rulebook' },
  { name: 'Invisible College', description: 'Scientists preserving knowledge from Vaticine persecution. They advance science and protect free thought.', source: 'Core Rulebook' },
  { name: 'Knights of the Rose & Cross', description: 'Champions of justice who protect the innocent. They fight for the oppressed regardless of nation or faith.', source: 'Core Rulebook' },
  { name: 'Los Vagabundos', description: 'Masked vigilantes fighting tyranny in Castille. They oppose the Inquisition and protect the people.', source: 'Core Rulebook' },
  { name: 'Mociutes Skara', description: 'Sarmatian witches guarding ancient pacts and traditions. They preserve the old ways and protect the Commonwealth.', source: 'Core Rulebook' },
  { name: 'Rilasciare', description: 'Revolutionary anarchists seeking to overthrow all tyrants. They fight against any form of unjust authority.', source: 'Core Rulebook' },
  { name: "Sophia's Daughters", description: 'Secret sisterhood protecting women across Theah. They work behind the scenes to empower women and oppose patriarchal tyranny.', source: 'Core Rulebook' },
  { name: 'Novus Ordo Mundi', description: 'Shadowy manipulators seeking to control nations from behind the scenes. A conspiracy of power brokers pulling strings across Theah.', source: 'Core Rulebook' },
