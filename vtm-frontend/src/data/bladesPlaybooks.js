...
export const BLADES_PLAYBOOKS = {
  Cutter: {
    ...
    abilities: [
      ...
      { name: 'Bodyguard', description: 'When you gather information to anticipate possible threats in the current situation, you get detailed answers. When you protect or cover someone, take +1d to your rolls.' },
      { name: 'Fearsome Aspect', description: 'When you intimidate, threaten, or commit violence, you\'re terrifying. Ask the GM who frees or surrenders, and who backs off slowly, and who hesitates.' },
      { name: 'Ghost Fighter', description: 'You may imbue your hands, melee weapons, or tools with spirit energy. Add +1d when you make a roll in combat vs. the supernatural. You may grapple with spirits to restrain and capture them.' },
      { name: 'Leader', description: 'When you Command a cohort in combat, they continue to fight when they would otherwise break (they\'re not taken out when they suffer level 3 harm). They gain +1 effect and 1 armor.' },
      { name: 'Like Hardened Steel', description: 'Permanently fill one segment of your healing clock. When you fight unarmed, your body is a fine weapon.' },
      { name: 'Mule', description: 'Your load limits are higher. Conspicuous: 8. Discreet: 6. You\'re encumbered at 9 boxes of load and can carry a maximum of 10 load. Carrying heavy items doesn\'t affect your speed or agility.' },
      { name: 'Not to be Trifled With', description: 'You can push yourself to do one of the following: perform a feat of physical force that verges on the superhuman — fight a battle as if your scale were equal to a small gang.' },
      { name: 'Veteran', description: 'Choose a special ability from another source. You can take this special ability more than once.' },
    ],
    items: [
  ...
  Hound: {
    ...
    abilities: [
      ...
      { name: 'Focused', description: 'You may expend your special armor to resist a consequence of surprise or mental harm (fear, confusion, losing track of someone) or to push yourself for ranged combat or tracking (or to activate a special ability, like Sharpshooter).' },
      { name: 'Ghost Hunter', description: 'Your hunting pet is imbued with spirit energy. It grants you +1d to rolls when tracking or fighting the supernatural, and gains an arcane ability: ghost-form, mind-link, or arrow-swift. Take this ability again to choose an additional arcane ability for your pet.' },
      { name: 'Scout', description: 'When you gather information to locate a target, you get detailed answers. When you hide in a prepared position or use camouflage, add +1d to any rolls you make.' },
      { name: 'Survivor', description: 'From hard-won experience or occult ritual, you are immune to the poisonous miasma of the deathlands and are able to subsist on the strange flora and fauna there. You get +1 Stress box.' },
      { name: 'Tough as Nails', description: 'You gain a second space to record level 3 harm. When you suffer a mortal wound, you may mark 3 Stress to stabilize it and stay alive.' },
  ...
  Leech: {
    ...
    abilities: [
      { name: 'Alchemist', description: 'When you invent or craft a creation with alchemical features, you get +1 Quality level. You begin with one special formula already known.' },
      ...
      { name: 'Artificer', description: 'When you invent or craft a creation with spark-craft features, you get +1 Quality level. You begin with one special design already known.' },
      ...
      { name: 'Ghost Ward', description: 'You know how to Wreck an area with arcane substances so it is either anathema or enticing to spirits (your choice).' },
      { name: 'Physicker', description: 'You can Tinker with bones, blood, and bodily humours to treat wounds. You can attempt to stabilize someone who just suffered a mortal injury. You may Study a poison, malady, or corpse. In downtime, use the recover activity to act as a Physicker for those who recover (including yourself) with Quality equal to your Tinker rating. If you have level 3 or 4 harm, you must recover before you use this ability.' },
      { name: 'Saboteur', description: 'When you Wreck, the work is much quieter than it should be and the damage is hidden from casual inspection.' },
  ...
  Lurk: {
    ...
    abilities: [
      ...
      { name: 'Contortionist', description: 'You can twist and fold your body to hide in impossibly small and tight spaces.' },
      { name: 'Daredevil', description: 'You get +1d for desperate rolls, but take -1d when you push yourself to avoid or reduce the consequence.' },
      ...
      { name: 'Expertise', description: 'Choose one of your actions. When you lead a group action using that action, you and your allies get +1d to push yourself rolls.' },
      { name: 'Ghost Veil', description: 'You may push yourself to shift partially into the ghost field, becoming shadowy and insubstantial for as long as you hold your breath. Take 1 Stress for each extra feature: you are invisible — you may float through the air like a ghost.' },
      ...
      { name: 'Shadow', description: 'You may expend your special armor to resist a consequence from detection or security measures, or to push yourself for a feat of athletics or stealth or to activate a special ability (like Ghost Veil).' },
      { name: 'Veteran', description: 'Choose a special ability from another source. You can take this special ability more than once.' },
    ],
    items: [
  ...
  Slide: {
    ...
    abilities: [
      { name: 'Rook\'s Gambit', description: 'Take 2 Stress to use your best action rating while performing a different action. Describe how you adapt your skill to this use.' },
      { name: 'Cloak & Dagger', description: 'When you use a disguise or other form of covert misdirection, you get +1d on rolls when you confuse or deflect suspicion. When you throw off your disguise, the resulting surprise gives you the initiative in the situation.' },
      { name: 'Ghost Voice', description: 'You know the secret method to interact with a ghost or demon as if it were a normal human, regardless of how wild or feral it appears. You gain +1d on rolls when you deceive or influence supernatural beings.' },
      ...
      { name: 'Mesmerism', description: 'When you Sway someone, you may cause them to forget it\'s happened until they next interact with you.' },
      { name: 'Subterfuge', description: 'You may expend your special armor to resist a consequence from suspicion or persuasion, or to push yourself for acts of subterfuge or to activate a special ability.' },
      { name: 'Trust in Me', description: 'When you deceive or influence a target with whom you have an intimate relationship, they\'re especially vulnerable to you. Also, add +1d if you need to make a threat roll against them.' },
      { name: 'Veteran', description: 'Choose a special ability from another source. You can take this special ability more than once.' },
    ],
    items: [
  ...
  Spider: {
    ...
    abilities: [
      { name: 'Foresight', description: 'Two free load worth of gear carried by you or a teammate. This is in addition to the gear on your playbook.' },
  ...
  Whisper: {
    ...
    abilities: [
      ...
      { name: 'Occultist', description: 'You know the secret ways to Consort with ancient powers, forgotten gods, and demons. Once you\'ve communed with them, you get +1d to Command them.' },
      ...
      { name: 'Tempest', description: 'You can push yourself to do one of the following: unleash a stroke of lightning as a weapon — Loss control of nearby electroplasmic devices.' },
