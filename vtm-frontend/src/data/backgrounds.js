...
const VAMPIRE_SPECIFIC = [
  ...
  { value: 'Pack Recognition', description: 'Reputation within your Sabbat pack. Higher levels mean greater authority.',
    levels: ['● Known pack member, minimal sway.', '●● Respected voice in pack decisions.', '●●● Trusted lieutenant, others follow your lead.', '●●●● Dominant figure whose word is near-law.', '●●●●● Legendary pack authority; your reputation echoes across the Sabbat.'] },
  ...
  { value: 'Wraith Contacts', description: 'Connections to the restless dead who provide information. (Necromancers)',
    levels: ['● A single ghostly informant.', '●● A couple of wraiths willing to trade secrets.', '●●● A reliable network among the restless dead.', '●●●● Well-connected across the Shadowlands.', '●●●●● Extensive contacts throughout the Underworld.'] },
]
...
const WEREWOLF_SPECIFIC = [
  ...
  { value: 'Spirit Heritage', description: 'Spiritual connections that make spirits friendlier to you.',
    levels: ['● Spirits are slightly more tolerant of you.', '●● Minor spirits are noticeably friendlier.', '●●● Spirits actively seek you out and offer aid.', '●●●● Powerful spirits treat you as kin.', '●●●●● Even great Incarna acknowledge your spiritual lineage.'] },
...
const MAGE_SPECIFIC = [
  ...
  { value: 'Backup', description: 'Support from your Tradition or Convention in emergencies.',
    levels: ['● A single colleague who might respond.', '●● A small team available for minor crises.', '●●● Reliable support from your faction.', '●●●● Rapid response from well-equipped operatives.', '●●●●● A full strike team or cabal at your call.'] },
  { value: 'Blessing', description: 'A permanent magical benefit from a spirit or Umbrood.',
    levels: ['● A minor supernatural boon.', '●● A useful persistent benefit.', '●●● A significant magical advantage.', '●●●● A powerful ongoing supernatural gift.', '●●●●● A legendary blessing of extraordinary power.'] },
  { value: 'Certification', description: 'Official status within the Technocracy or Traditions.',
    levels: ['● Basic credentials recognised internally.', '●● Certified specialist in one area.', '●●● Recognised authority with clearance.', '●●●● Senior certification with broad access.', '●●●●● Top-level clearance and institutional authority.'] },
  ...
  { value: 'Demesne', description: 'A personal magical sanctum you\'ve shaped to your will.',
    levels: ['● A small space with minor magical attunement.', '●● A room-sized area shaped to your paradigm.', '●●● A well-established personal realm.', '●●●● A powerful demesne that bends reality to your will.', '●●●●● A vast personal domain, deeply attuned to your magic.'] },
  ...
  { value: 'Enhancement', description: 'Permanent Technocratic augmentation — cybernetics, bioware, or nanites.',
    levels: ['● Minor implant or biomod.', '●● Useful augmentation — enhanced senses or reflexes.', '●●● Significant cybernetic or biological upgrade.', '●●●● Multiple major enhancements.', '●●●●● Cutting-edge full-body augmentation suite.'] },
  { value: 'Genius', description: 'Extraordinary natural intelligence or creative capacity.',
    levels: ['● Bright — occasional flashes of insight.', '●● Gifted — rapid problem-solving.', '●●● Brilliant — innovative leaps of logic.', '●●●● Prodigious intellect — paradigm-shifting ideas.', '●●●●● Once-in-a-generation genius.'] },
  { value: 'Hypercram', description: 'Ability to learn and absorb information at superhuman speed.',
    levels: ['● Speed-read simple texts.', '●● Absorb a textbook in hours.', '●●● Master a new subject in days.', '●●●● Learn complex skills almost overnight.', '●●●●● Near-instant absorption of any information.'] },
  { value: 'Legend', description: 'Your magical reputation precedes you — for good or ill.',
    levels: ['● Known within your local cabal or construct.', '●● Recognised across your Tradition or Convention.', '●●● A name spoken in multiple factions.', '●●●● Famous (or infamous) throughout the Awakened world.', '●●●●● A living legend — your deeds are the stuff of myth.'] },
  ...
  { value: 'Past Lives', description: 'Memories from previous incarnations that inform the present.',
    levels: ['● Vague déjà vu and fleeting impressions.', '●● Occasional clear memories from a past life.', '●●● Reliable access to past-life knowledge.', '●●●● Vivid recall; can draw on past-life skills.', '●●●●● Past incarnations feel like lived experience.'] },
  { value: 'Patron', description: 'A powerful spirit, Umbrood, or entity that sponsors you.',
    levels: ['● A minor spirit offers occasional aid.', '●● A moderate entity provides regular support.', '●●● A powerful patron with significant resources.', '●●●● A major Umbrood or entity champions your cause.', '●●●●● An ancient, powerful being is your devoted sponsor.'] },
  { value: 'Requisitions', description: 'Technocratic resource allocation for equipment and support.',
    levels: ['● Basic field gear and minor supplies.', '●● Standard-issue equipment and modest budgets.', '●●● Advanced tech and significant funding.', '●●●● Experimental prototypes and large budgets.', '●●●●● Top-priority access to the Union\'s finest resources.'] },
  { value: 'Cult', description: 'Devoted believers who revere you and can lend their faith to your rituals.',
    levels: ['● Tiny cult: 3-7 people.', '●● Small cult: 8-12 people.', '●●● Moderate cult: 13-17 people.', '●●●● Large cult: 18-22 people.', '●●●●● Huge cult: 23-30 people.'] },
  { value: 'Familiar/Companion', description: 'A non-human helper with special abilities and a magical bond.',
    levels: ['● A small, subtle companion.', '●● A capable, intelligent familiar.', '●●● A powerful companion with notable abilities.', '●●●● A formidable entity with strong magical ties.', '●●●●● A legendary being of great power.'] },
  { value: 'Rank', description: 'A title of importance within Kithain or Awakened society.',
    levels: ['● A minor title or recognition.', '●● A respected position.', '●●● A significant authority figure.', '●●●● A major leader with broad influence.', '●●●●● One of the most powerful figures in your faction.'] },
  { value: 'Sanctum', description: 'A personal magical workspace separate from a chantry.',
    levels: ['● A closet or corner dedicated to your Art.', '●● A private room set up for magical work.', '●●● A well-appointed personal laboratory.', '●●●● A fortified sanctum with extensive resources.', '●●●●● A legendary personal workspace of great power.'] },
  { value: 'Secret Weapons', description: 'Hidden magical items or devices for emergencies.',
    levels: ['● A single hidden magical trinket.', '●● A concealed device of moderate power.', '●●● Several secret items for various situations.', '●●●● A cache of powerful hidden weapons.', '●●●●● An arsenal of devastating secret devices.'] },
  { value: 'Spies', description: 'A network of informants and intelligence sources.',
    levels: ['● One informant in a single area.', '●● A few contacts across a couple of fields.', '●●● Informants in several areas of interest.', '●●●● A wide intelligence network.', '●●●●● An extensive spy ring with deep infiltration.'] },
  { value: 'Status', description: 'Favored position among your peers and within your faction.',
    levels: ['● Known and somewhat respected.', '●● A reliable and valued member.', '●●● A person of authority and influence.', '●●●● A leader whose word carries great weight.', '●●●●● One of the most esteemed figures in your group.'] },
  { value: 'Totem (Mage)', description: 'A powerful spirit ally (shamanic characters only).',
    levels: ['● A faint spiritual presence offering intuitions.', '●● A recognisable spirit guide with minor gifts.', '●●● A powerful totem granting real advantages.', '●●●● A major spirit deeply bonded to your practice.', '●●●●● A legendary spirit patron of immense power.'] },
  { value: 'Wonder', description: 'A Talisman, Fetish, or Device that bends reality on its own.',
    levels: ['● Minor trinket with a single effect.', '●● Useful magical tool.', '●●● Significant enchanted item.', '●●●● Powerful magical artifact.', '●●●●● Legendary wonder of great power.'] },
]
