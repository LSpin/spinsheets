...
export const L5R_EQUIPMENT = {
  ...
  adventuringGear: [
    { name: 'Calligraphy Set', cost: '5 bu', notes: 'Writing brushes, ink stone, and paper for correspondence and art.' },
    { name: 'Scroll Satchel', cost: '1 koku', notes: 'Waterproof case for carrying spell scrolls and important documents.' },
    { name: 'Traveling Pack', cost: '1 koku', notes: 'Bedroll, flint & steel, chopsticks, spare clothing, week\'s rations, small knife.' },
    { name: 'Sturdy Clothing', cost: '\u2014', notes: 'Standard durable samurai garb for travel.' },
    { name: 'Fine Clothing', cost: '5 koku', notes: 'Elaborate silk kimono and accessories suitable for court.' },
    { name: 'Extravagant Clothing', cost: '20 koku', notes: 'Magnificent court attire of the finest materials.' },
    { name: 'Riding Horse', cost: '15 koku', notes: 'Trained riding horse with saddle and tack.' },
    { name: 'Utaku Warhorse', cost: '\u2014', notes: 'Battle-trained Utaku steed. Cannot be purchased \u2014 only granted by the Utaku family.' },
    { name: 'Biwa', cost: '3 koku', notes: 'Four-stringed lute used in musical performance.' },
    { name: 'Shamisen', cost: '2 koku', notes: 'Three-stringed instrument popular in entertainment.' },
    { name: 'Sake Set', cost: '2 bu', notes: 'Ceramic flask and cups for serving sake.' },
    { name: 'Lantern', cost: '5 bu', notes: 'Paper or metal lantern with oil supply.' },
    { name: 'Rope, 50 ft', cost: '5 bu', notes: 'Hemp rope suitable for climbing or binding.' },
    { name: 'Grappling Hook', cost: '1 koku', notes: 'Iron hook for climbing. +1k0 to Athletics (Climbing) rolls.' },
    { name: 'Finger of Jade', cost: '1 koku', notes: 'Small piece of jade. Darkens in the presence of the Shadowlands Taint.' },
    { name: 'Jade Pendant', cost: '5 koku', notes: 'Worn jade amulet. Protects against minor Taint exposure.' },
    { name: 'Crystal of Air', cost: '10 koku', notes: 'Grants +1k0 to Perception-based rolls while held. Fragile.' },
    { name: 'Crystal of Earth', cost: '10 koku', notes: 'Grants +1k0 to Willpower-based rolls while held. Fragile.' },
    { name: 'Smoke Bomb', cost: '3 bu', notes: '+10 to TN to be hit for 1 round. Creates obscuring cloud.' },
    { name: 'Metsubushi (Blinding Powder)', cost: '2 bu', notes: 'Thrown in face. Target rolls Reflexes TN 15 or blinded 1 round.' },
    { name: 'Ninja Climbing Tools', cost: '5 bu', notes: 'Hand and foot claws for climbing. +1k0 to Stealth (Sneaking) while climbing.' },
    { name: 'Disguise Kit', cost: '5 koku', notes: 'Makeup, wigs, and costume pieces. +1k0 to Acting (Disguise) rolls.' },
    { name: 'Poison \u2014 Rank 1', cost: '5 koku', notes: 'Contact or ingested. Target rolls Stamina TN 15 or takes 2k1 damage.' },
    { name: 'Poison \u2014 Rank 3', cost: '20 koku', notes: 'Contact or ingested. Target rolls Stamina TN 25 or takes 4k2 damage.' },
    { name: 'Tea Set', cost: '1 koku', notes: 'Formal tea ceremony implements.' },
    { name: 'Go Set', cost: '2 koku', notes: 'Board and stones for the strategic game of Go.' },
    { name: 'Shogi Set', cost: '1 koku', notes: 'Board and pieces for Japanese chess.' },
  ],
  siegeWeapons: [
    { name: 'Siege Tower', cost: '\u2014', notes: 'Wheeled tower for approaching castle walls. Provides cover for 10+ warriors.' },
    { name: 'Battering Ram', cost: '\u2014', notes: 'Crew-operated ram for breaking gates. STR 8 effective.' },
    { name: 'Fire Arrows (per 20)', cost: '5 koku', notes: 'Arrows with oil-soaked wrappings. Set targets alight on hit.' },
  ],
  schoolWeapons: [
    // Crab Clan
...
export const L5R_EQUIPMENT_CATEGORIES = [
  ...
  { key: 'adventuringGear', label: 'Adventuring Gear' },
  { key: 'siegeWeapons', label: 'Siege Weapons' },
]
